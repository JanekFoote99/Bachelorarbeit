...
Dadurch konnte in Krisenmomenten schnell reagiert werden, um so größeren Katastrophen frühzeitig abzuwenden, aber leider auch, solche zu verursachen \cite{Nugaliyadde2014}.
...
\begin{figure}[htb]
  ...
  \caption[Upload Statistik zu YouTube Videos, die monatlich hochgeladen werden]{\textbf{Upload Statistik zu YouTube Videos, die monatlich hochgeladen werden} Die Anzahl an Minuten, die auf YouTube hochgeladen werden.
...
Dazu werden Verfahren wie \textit{Trancoding}, \textit{Transsizing} und \textit{Transrating} verwendet. \newline
...
Das sollte jedoch nicht zu oft angewendet werden, da die Qualität beim wiederholten Komprimieren und Dekomprimieren verloren geht; sollten die Verfahren verlustbehaftet sein \cite{Sun2004}. \newline
...
In einer komplexen Szene können mehrere Millionen Dreiecke sichtbar sein, die, je nach Anwendung, in Echtzeit dargestellt werden müssen.
...
Weitere Anwendungsfälle für 3D-Modelle in der Unterhaltungsbranche sind Videospiele, visuelle Effekte in Film und Fernsehen, in \textit{Virtual Reality (VR)} und 3D-Hologramme für Shows und in Themenparks. 
...
Ziel dieser Arbeit ist, ein beliebiges, komprimiertes Dreiecksnetz zu dekomprimieren und darzustellen.
Dazu soll untersucht werden, wie schnell die Dekompression der Dreiecksnetze erfolgt und welche Kompressionsverhältnisse Brotli-G liefert.